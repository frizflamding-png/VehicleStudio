         ...
         <div className="flex items-center justify-between">
          <Link href="/" className="text-base font-semibold text-white tracking-tight">
           ...
           <details className="relative">
             ...
             <div className="absolute right-0 mt-2 w-52 bg-slate-900 border border-slate-800 rounded-lg shadow-lg py-2">
               <a
                 href="#features"
                 className="block px-3 py-2 text-sm text-slate-300 hover:bg-slate-800/70"
               >
                 ...
                 <>
                  {onSignIn ? (
                    <button
                      type="button"
                      onClick={onSignIn}
                      className="block w-full text-left px-3 py-2 text-sm text-slate-300 hover:bg-slate-800/70"
                    >
                      Sign in
                    </button>
                  ) : (
